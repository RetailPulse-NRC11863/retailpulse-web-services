...
public record CreateOperationalAlertCommand(Long storeId, String title, String description, AlertType type, PriorityLevel priority, Long productId, Long zoneId, String source, String triggerReason) {
}

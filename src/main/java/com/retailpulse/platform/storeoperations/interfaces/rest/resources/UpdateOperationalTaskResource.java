...
public record UpdateOperationalTaskResource(@NotBlank String title, @NotBlank String description, @NotNull PriorityLevel priority, @NotNull TaskStatus status, @NotBlank String zoneId, @NotBlank String zoneName, String alertId) {
}

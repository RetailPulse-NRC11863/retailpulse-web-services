...
public record OperationalTaskResource(Long id, Long storeId, String title, String description, TaskStatus status, PriorityLevel priority, Long alertId, Long productId, Long zoneId, String source, String triggerReason) {
}

...
public class Result<T> {
    ...
    public static <T> Result<T> failure(ApplicationError error) { return new Result<>(null, error); }
    public boolean isSuccess() { return error == null; }
    public Optional<T> value() { return Optional.ofNullable(value); }
    public Optional<ApplicationError> error() { return Optional.ofNullable(error); }
}

...
public class UpdateZoneCommandFromResourceAssembler {
    public static UpdateZoneCommand toCommand(Long zoneId, UpdateZoneResource resource) { return new UpdateZoneCommand(zoneId, resource.name(), resource.type(), resource.capacity()); }
}
